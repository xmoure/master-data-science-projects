...
m15 <- stats::step(m14, k=log(nrow(dfwork)))
m16 <- stats::step(m14) # model with more antiractions, satisfaction seems to be a significnt factor,fit  feet and number param.
Anova(m15, test="LR") 
