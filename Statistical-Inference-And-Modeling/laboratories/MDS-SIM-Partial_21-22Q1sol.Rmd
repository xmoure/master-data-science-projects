...
#outer treshhold ( 3 times the outer range...)
...
```{r}
# acvhieve 99% significance level so we have to set proba = 0.01 that is not the default
#num.var is the 8th value because cal esta en la posicion 8
